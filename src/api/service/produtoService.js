...
module.exports = {
    ...
    save: (req, res) => {
        ...
        if(produto.descricao == undefined || produto.descricao == null)
            messagens.push("The 'descricao' field must be filled!")
        if(produto.valor == undefined || produto.valor == null)
            messagens.push("The 'valor' field must be filled!")
        if(produto.idCategoria == undefined || produto.idCategoria == null)
            messagens.push("The 'idCategoria' field must be filled!")
    ...
    calcParcelas: (req, res) => {
        ...
        if(qtdParcelas == undefined || qtdParcelas == null)
            messagens.push("The 'qtdParcelas' field must be filled!")
